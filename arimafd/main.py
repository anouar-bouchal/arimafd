...
class Arima_anomaly_detection(Anomaly_detection):
    ...
    def fit(self, history_dataset, window=100, No_metric=1, window_insensitivity=100):
    ...
    def predict(self, data, window=100, No_metric=1, window_insensitivity=100):
        ...
        tensor = np.zeros((data.shape[0], data.shape[1], self.ar_order + 1))
        j = 0
